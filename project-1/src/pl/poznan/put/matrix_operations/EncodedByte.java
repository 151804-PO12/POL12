//Some calculations were melting my brain, so I resorted to the lazy and tedious way of hard-coded lookup tables.
public class EncodedByte {
    private final int encoded;
    public EncodedByte(byte input)
    {
        //Converting from signed to unsigned to be easier to work with.
        //Hopefully a single conditional addition doesn't qualify as heavy calculations in constructor.
        if(input < 0) {
            encoded = input + 256;
        }
        else {
    ...
    private static final byte[] InverseSBox =
    ...
    private static final byte[] MutliplyBy2 =
    ...
    private static final byte[] MutliplyBy3 =
    ...
    private static final byte[] MutliplyBy9 =
    ...
    private static final byte[] MutliplyBy11 =
    ...
    private static final byte[] MutliplyBy13 =
    ...
    private static final byte[] MutliplyBy14 =
    ...
    public byte SBoxValue()
    {return SBox[encoded];}
    public byte InverseSBoxValue()
    {return InverseSBox[encoded];}
    public byte MultipliedBy2()
    {return MutliplyBy2[encoded];}
    public byte MultipliedBy3()
    {return MutliplyBy3[encoded];}
    public byte MultipliedBy9()
    {return MutliplyBy9[encoded];}
    public byte MultipliedBy11()
    {return MutliplyBy11[encoded];}
    public byte MultipliedBy13()
    {return MutliplyBy13[encoded];}
    public byte MultipliedBy14()
    {return MutliplyBy14[encoded];}
}
